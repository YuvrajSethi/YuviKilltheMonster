...
function setup() {
 ...
 // box12 = new Box(800, 100, 70, 70);
  ...
  box17 = new Box(700, 450, 70, 70);
  box18 = new Box(700, 550, 70, 70);
  //box19 = new Box(700, 100, 70, 70);
  box20 = new Box(600, 50, 70, 70);
  box21 = new Box(600, 150, 70, 70);
  box22 = new Box(600, 250, 70, 70);
  box23 = new Box(600, 350, 70, 70);
  box24 = new Box(600, 450, 70, 70);
  box25 = new Box(600, 550, 70, 70);
...
function draw() {
  ...
  //if (Box.isTouching(monster)){
   // this.monster.Visibility = 0;}
